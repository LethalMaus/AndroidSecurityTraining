    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AndroidSecurityTrainingTheme {
                DeepLinksHome(currentIntent = currentIntentState.value)
            }
        }
    }
...
@Composable
fun DeepLinksHome(currentIntent: Intent?) {
...
@Preview
@Composable
internal fun DeepLinksHomePreview() {
   DeepLinksHome(currentIntent = null)
}
